...
<body ng-controller="userController">
    <div class="col-md-12 header">
       <div class="logo"><h3 style="color:white;font-size:1.8em;text-align:right;">Shuttle Section</h3></div> 
    </div>
    ...
    <button class="btn btn-primary" ng-click="openUpdateModal(details)"><span class="glyphicon glyphicon-edit"></span> Edit Profile</button>
